...
function _precompile_()
    ...
    Base.precompile(Tuple{Core.kwftype(typeof(plot!)),NamedTuple{(:annotation,), Tuple{Tuple{Vector{Int64}, Vector{Float64}, Vector{String}}}},typeof(plot!)})
    Base.precompile(Tuple{Core.kwftype(typeof(plot!)),NamedTuple{(:annotation,), Tuple{Tuple{Vector{String}, Vector{String}, Vector{PlotText}}}},typeof(plot!)})
    ...
    Base.precompile(Tuple{Core.kwftype(typeof(plot)),NamedTuple{(:ms, :legend, :tickfontsize, :seriestype), Tuple{Int64, Bool, Int64, Symbol}},typeof(plot),Vector{String},Vector{String}})
    ...
    Base.precompile(Tuple{typeof(annotate!),Any,Any,Any})
    ...
    Base.precompile(Tuple{typeof(process_annotation),Subplot{GRBackend},Vector{Int64},Vector{Float64},Vector{String}})
    Base.precompile(Tuple{typeof(process_annotation),Subplot{GRBackend},Vector{String},Vector{String},Vector{PlotText}})
    ...
    Base.precompile(Tuple{typeof(process_annotation),Subplot{PlotlyBackend},Vector{Int64},Vector{Float64},Vector{String}})
    ...
    Base.precompile(Tuple{typeof(text),String,Symbol,Symbol,Vararg{Any, N} where N})
    ...
    isdefined(Plots, Symbol("#305#341")) && Base.precompile(Tuple{getfield(Plots, Symbol("#305#341"))})
    isdefined(Plots, Symbol("#306#342")) && Base.precompile(Tuple{getfield(Plots, Symbol("#306#342"))})
    isdefined(Plots, Symbol("#327#363")) && Base.precompile(Tuple{getfield(Plots, Symbol("#327#363"))})
    ...
    let fbody = try __lookup_kwbody__(which(annotate!, (Any,Vararg{Any, N} where N,))) catch missing end
    if !ismissing(fbody)
        precompile(fbody, (Any,typeof(annotate!),Any,Vararg{Any, N} where N,))
    end
end
    ...
    let fbody = try __lookup_kwbody__(which(get_ticks, (Subplot{GRBackend},Axis,))) catch missing end
    if !ismissing(fbody)
        precompile(fbody, (Bool,Function,typeof(get_ticks),Subplot{GRBackend},Axis,))
    end
end
    let fbody = try __lookup_kwbody__(which(get_ticks, (Subplot{GRBackend},Axis,))) catch missing end
    if !ismissing(fbody)
        precompile(fbody, (Bool,Symbol,typeof(get_ticks),Subplot{GRBackend},Axis,))
    end
end
